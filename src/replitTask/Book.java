...
public class Book {
     ...
     */
        ...
        /**
         ...
         - The method returns false => if word parameter is one of articles, coordinate
         conjunctions, or prepositions. See full list below
        ...
        public static Boolean isTitleWord(String word) {
            ArrayList<String> list = new ArrayList<>(Arrays.asList("a" , "an", "the", "and", "but", "for", "nor", "or", "so", "yet", "at", "by", "in",
                    "into", "near", "of", "on", "to", "than", "via"));
        ...
        if (author.isEmpty()){
            ...
            unknownAuthors++;
              ...
              if (author.contains(" ")){
                  ...
                  this.author = capitalize(author.substring(0,index)) + " " + capitalize(author.substring(index + 1));
       ...
       if (title.isEmpty()){
           ...
           if(title.contains(" ")){
               for (int i = 0; i < arr.length; i++) {
                   if (isTitleWord(arr[i])|| i == 0){

                       newTit += capitalize(arr[i]) + " ";
                   }else{
                       newTit += arr[i].toLowerCase() + " ";
                   }

               }
               this.title = newTit.trim();
           }else if (!title.contains(" ")&& isTitleWord(title)){
